...
export default function AdminPage() {
  const { products, orders, catalogSource, pendingProducts, addProduct, updateProduct, deleteProduct, syncLocalProducts, updateOrderStatus } = useStore();
  ...
  useEffect(() => {
    ...
    button.textContent = syncButtonLabel;
  ...
  }, [pendingProducts.length, section, syncLocalProducts]);
