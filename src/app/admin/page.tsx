...
const emptyForm = { name: "", bn: "", category: DEFAULT_CATEGORY_SLUG as string, hotDeal: false, price: "", oldPrice: "", stock: "", sku: "", image: "", image2: "", video: "", description: "", nutrition: "", storageInstructions: "" };
...
export default function AdminPage() {
  ...
  const openEdit = (product: Product) => {
    setEditing(product);
    setForm({ name: product.name, bn: product.bn, category: product.category, hotDeal: product.hotDeal === true, price: String(product.price), oldPrice: String(product.oldPrice), stock: String(product.stock), sku: product.sku || "", image: product.image, image2: product.image2 || "", video: product.video || "", description: product.description || "", nutrition: product.nutrition || "", storageInstructions: product.storageInstructions || "" });
    setSection("products");
  };
